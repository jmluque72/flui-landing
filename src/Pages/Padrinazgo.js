        ...
        return (
            <div style={{ width:'100%',height: !width ? height :height + 350 ,backgroundImage:`url(${background})`,backgroundSize:'cover', display:'flex',flexDirection:'column'}}>
                <Grid container direction='row' style={{ height:'100%'}}>
                    ...
                    <Grid item  xs={12} sm={12} md={6} lg={6} style={{display:'flex',flexDirection:'column',justifyContent:'center',marginLeft:width&&15,marginTop: width&& 50}}>
                        ...
                        <div style={{width:'65%',height:width && 160,display:'flex',flexDirection: width ? 'column' : 'row',justifyContent:'',marginTop:15}}>
                            <a onClick={() => this.link2()} download style={{ textDecoration:'none'}}>
                                <Button
                                    style={{ backgroundColor:'#d13852',height:45,width:180,marginLeft:20}}
                                    variant="contained"
                                    startIcon={
